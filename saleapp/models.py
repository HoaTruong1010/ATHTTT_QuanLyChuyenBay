...
if __name__ == '__main__':
    with app.app_context():
        ...
        u1 = User(name=encoding_no2('An'), username=encoding_no2('u1'), password=password,email=encoding_no2('123@gmail.com'), diachi='abc',
                  user_role=UserRole.USER)
        u2 = User(name=encoding_no2('Binh'), username=encoding_no2('u2'), password=password,email=encoding_no2('12@gmail.com'), diachi='abc',
                  user_role=UserRole.STAFF)
        u3 = User(name=encoding_no2('Dong'), username=encoding_no2('u3'), password=password,email=encoding_no2('12e@gmail.com'), diachi='abc',
